...
struct trainer_option {
    trainer_option() : u_bias(true), w_bias(true), piece_num(4),
                       ...
                       threads_num(1), b_init(false), is_debug(false) {}
    ...
    bool u_bias, w_bias, b_init, is_debug;
    ...
    void parse_option(const vector <string> &args) {
        ...
        for (int i = 0; i < argc; ++i) {
            if (args[i].compare("-m") == 0) {
                ...
                if (i == argc - 1)
                    throw invalid_argument("invalid command\n");
                is_debug = (0 == stoi(args[++i])) ? false : true;
            } else {
                throw invalid_argument("invalid command\n");
                break;
            }
    ...
    void print_option() {
        cout << "train option params:" << endl;
        cout << "\tu_bias: " << this->u_bias << endl;
        cout << "\tw_bias: " << this->w_bias << endl;
        cout << "\tpiece_num: " << this->piece_num << endl;
        cout << "\tu_mean: " << this->u_mean << endl;
        cout << "\tw_mean: " << this->w_mean << endl;
        cout << "\tu_stdev: " << this->u_stdev << endl;
        cout << "\tw_stdev: " << this->w_stdev << endl;
        cout << "\tu_alpha: " << this->u_alpha << endl;
        cout << "\tw_alpha: " << this->w_alpha << endl;
        cout << "\tu_beta: " << this->u_beta << endl;
        cout << "\tw_beta: " << this->w_beta << endl;
        cout << "\tu_l1: " << this->u_beta << endl;
        cout << "\tw_l1: " << this->w_beta << endl;
        cout << "\tu_l2: " << this->u_beta << endl;
        cout << "\tw_l2: " << this->w_beta << endl;
        cout << "\tthreads_num: " << this->threads_num << endl;
        cout << "\tb_init: " << this->b_init << endl;
        cout << "\tis_debug: " << this->is_debug << endl;
    }
